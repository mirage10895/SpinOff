...
public class SerieViewModel extends AndroidViewModel {
    ...
    @Getter private final LiveData<Serie> serie;
    @Getter private final LiveData<List<Serie>> series;
    @Getter private final LiveData<Season> season;
    @Getter private final LiveData<Episode> episode;
    @Getter private final LiveData<List<SerieDatabase>> databaseSeries;
    ...
    public SerieViewModel(@NonNull Application application) {
        ...
        this.serie = Transformations.switchMap(serieIdTrigger, apiRepository::getSerieById);
    ...
    public void initGetSerieById(Integer id) { serieIdTrigger.setValue(id); }
    ...
    private static class SerieRequest {
        String type; Integer page; List<Serie> previous;
        SerieRequest(String t, Integer p, List<Serie> prev) { type=t; page=p; previous=prev; }
    }
    private static class SeasonRequest {
        Integer id; Integer seasonNumber;
        SeasonRequest(Integer i, Integer s) { id=i; seasonNumber=s; }
    }
    private static class EpisodeRequest {
        Integer id; Integer seasonNumber; Integer episodeNumber;
        EpisodeRequest(Integer i, Integer s, Integer e) { id=i; seasonNumber=s; episodeNumber=e; }
    }
}
